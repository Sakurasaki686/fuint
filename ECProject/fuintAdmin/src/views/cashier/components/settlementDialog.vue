            ...
            <div class="left">
                ...
                <div class="content">
                   ...
                   <div :class="'pay-item' + (payType == 'BALANCE' ? ' active' : '')" @click="selectPayType('BALANCE')">
                      <svg t="1656295559018" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6471" width="32" height="32"><path d="M512 0a512 512 0 1 0 512 512A512 512 0 0 0 512 0z m286.4896 668.16a78.2336 78.2336 0 0 1-78.208 78.208H303.1808A78.2336 78.2336 0 0 1 224.9728 668.16V355.3536a78.1312 78.1312 0 0 1 78.1568-78.2336h417.1008a78.2336 78.2336 0 0 1 78.208 78.2336v91.1616h-208.5632a65.2032 65.2032 0 1 0 0 130.4064h208.6144z m-143.36-156.3904a39.1168 39.1168 0 1 1-39.1168-39.0912 39.1168 39.1168 0 0 1 39.0656 39.1936z" fill="#EE9A49" p-id="6472"></path></svg>
            ...
            <div class="right">
                ...
                <div class="content">
                  <div class="member-info" v-if="memberInfo">
                      ...
                      <div class="item"><div class="head">名称：</div><div class="value">{{ memberInfo.name }}</div></div>
                  ...
                  <div class="guest" v-if="!memberInfo">
                       ...
                       <el-button size="mini" type="danger" icon="el-icon-plus" @click="bindToMember()">关联会员</el-button>
                  </div>
                </div>
            </div>
          </div>
