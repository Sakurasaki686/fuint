...
(2,'product',1,0,'小清新水果刀三件套',4,'6975486820418','Y','/static/uploadImages/20220110/6b67b70f35734ff28a03aa3d82ac96a0.jpg','[\"/static/uploadImages/20220110/6b67b70f35734ff28a03aa3d82ac96a0.jpg\"]',0.01,20.00,1946,2.00,'',0,33,'小清新','Y','N',1,'<h2>123</h2>','2021-10-13 14:19:45','2023-07-31 20:01:44','fuint','A'),
...
(4,'product',1,0,'筷子便携餐盒3件套',1,'6914068026176','N','/static/uploadImages/20220110/31cbf7ad0ef442a4b10dcefc24db0662.jpg','[\"/static/uploadImages/20220110/31cbf7ad0ef442a4b10dcefc24db0662.jpg\"]',80.00,99.00,4010,1.00,'',0,1325,'一体成型','Y','N',1,'<p>测试商品</p>','2021-10-14 05:46:23','2023-07-28 15:13:50','fuint','A'),
(5,'product',1,0,'简壳 一拖三可收纳伸缩充电线',2,'6922577729501','N','/static/uploadImages/20220110/856dbc96197e4782b4febb7a6e671bcb.jpg','[\"/static/uploadImages/20220110/856dbc96197e4782b4febb7a6e671bcb.jpg\"]',0.10,100.00,3877,0.00,'',0,1168,'可伸缩','Y','Y',1,'<p><br></p>','2021-10-14 05:47:31','2023-07-24 19:00:45','fuint','A'),
...
CREATE TABLE `mt_message` (
  ...
  `STATUS` char(1) DEFAULT 'A' COMMENT '状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='系统消息表';
...
CREATE TABLE `mt_order` (
  ...
  `SETTLE_STATUS` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'A' COMMENT '结算状态',
...
CREATE TABLE `mt_point` (
  ...
  `STATUS` char(1) DEFAULT 'A' COMMENT '状态，A正常；D作废',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='积分变化表';
...
CREATE TABLE `mt_sms_template` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='短信模板';
...
(1,1,0,'会员登录验证码','login-code','SMS_129758678','您的验证码是：{code}，该验证码仅用于登录验证，请放心泄露给他人使用哈。','2022-08-23 11:41:16','2023-07-11 14:36:24','fuint','A'),
(2,1,0,'会员收到优惠券','received-coupon','SMS_187944564','您的Fuint优惠券账户内已收到优惠券{totalNum}张，总额{totalMoney}元。请您关注Fuint公众号（Fuint卡券系统），在我的优惠券中通过本手机号登录查看。','2022-05-11 09:27:14','2022-05-11 09:27:14','fuint','A'),
(3,1,0,'优惠券被核销','confirm-coupon','SMS_129758679','尊敬的用户，您的[{couponName}]已在[{storeName}]完成核销，该券消费流水号为[{sn}]，谢谢您的光临！','2020-04-18 17:06:25','2020-04-18 17:06:25','sysadmin','A'),
(4,1,0,'会员注册完成','register-sms','SMS_129768678','您的Fuint优惠券账户已注册完成。请您关注Fuint卡券公众号（Fuint卡券系统），在我的优惠券中通过本手机号登录查看。','2020-04-18 17:15:11','2020-04-18 17:15:11','sysadmin','A'),
(5,1,0,'核销人员审核通过','confirmer-authed','SMS_129756978','{name}，您的店铺核销人员登记已完成审核，可以在{storeName}进行优惠券核销，谢谢！','2020-04-18 17:07:03','2020-04-18 17:07:03','sysadmin','A'),
(62,1,0,'测试模板','test-templet','143456','还未','2023-07-11 14:37:19','2023-07-11 14:37:41','','D'),
(63,1,0,'会员登录验证码','eqrqw','rqwq','tqwtqwt','2023-07-23 22:12:56','2023-07-23 22:13:07','','D'),
(65,1,0,'会员下单成功','order','MMMN','尊敬的用户，您的[{order_id}]已在[{storeName}]下单完成，谢谢您的光临！','2023-07-24 11:28:26','2023-07-24 11:28:26','','A');
...
(4,1,3,6020,1,'16671050702','符小安',NULL,'2023-07-24 18:57:49','2023-09-22 09:54:30','A','2023-09-22 09:54:30','123'),
(5,1,3,6024,2,'16671050703','符SQ',NULL,'2023-07-24 20:12:31','2023-09-22 09:33:44','A','2023-09-22 09:33:44','123');
...
insert  into `mt_store`(`ID`,`MERCHANT_ID`,`NAME`,`QR_CODE`,`LOGO`,`IS_DEFAULT`,`CONTACT`,`WX_MCH_ID`,`WX_API_V2`,`ALIPAY_APP_ID`,`ALIPAY_PRIVATE_KEY`,`ALIPAY_PUBLIC_KEY`,`PHONE`,`ADDRESS`,`LATITUDE`,`LONGITUDE`,`DISTANCE`,`HOURS`,`LICENSE`,`CREDIT_CODE`,`BANK_NAME`,`BANK_CARD_NAME`,`BANK_CARD_NO`,`DESCRIPTION`,`CREATE_TIME`,`UPDATE_TIME`,`STATUS`,`OPERATOR`) values 
...
insert  into `t_action_log`(`id`,`merchant_id`,`store_id`,`action_time`,`time_consuming`,`client_ip`,`module`,`url`,`acct_name`,`user_agent`,`client_port`) values 
(1,1,0,'2023-11-13 18:12:47',4,'127.0.0.1','退出后台系统','/backendApi/login/logout','fuint','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(2,1,0,'2023-11-13 18:12:56',22,'127.0.0.1','登录后台系统','/backendApi/login/doLogin','fuint','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(3,0,0,'2023-11-13 18:13:36',5,'127.0.0.1','新增后台菜单','/backendApi/source/add','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(4,0,0,'2023-11-13 18:14:32',1,'127.0.0.1','新增后台菜单','/backendApi/source/add','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(5,0,0,'2023-11-13 18:15:15',1,'127.0.0.1','新增后台菜单','/backendApi/source/add','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(6,0,0,'2023-11-13 18:20:07',57,'127.0.0.1','更新后台角色','/backendApi/duty/update','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(7,0,0,'2023-11-13 18:21:07',52,'127.0.0.1','更新后台角色','/backendApi/duty/update','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(8,0,0,'2023-11-13 18:21:12',2,'127.0.0.1','退出后台系统','/backendApi/login/logout','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0),
(9,0,0,'2023-11-13 18:21:18',4,'127.0.0.1','登录后台系统','/backendApi/login/doLogin','admin','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=12284 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='菜单表';
...
(0,81,'核销流水','/backend/confirmLog/confirmLogList','coupon/confirmLog/index','CouponConfirmLogIndex','select','D',2,'4',1,'核销记录列表',50,1,NULL),
...
(0,124,'收银台','cashier/index','cashier/index','CashierIndex','select','A',2,'4',0,NULL,125,1,NULL),
(0,125,'收银管理','cashier','cashier','Cashier','tab','A',1,'10',0,NULL,NULL,1,NULL),
(0,126,'核销订单','cashier/confirmOrder','cashier/confirmOrder','CashierConfirmOrder','select','A',2,'0',0,NULL,125,1,NULL),
...
(0,153,'分佣提成','commission','commission','Commission','tree','D',1,'12',1,NULL,NULL,1,NULL),
(0,154,'分佣规则','commission/rule/index','commission/rule/index','CommissionRuleIndex','select','D',2,'0',1,NULL,153,1,NULL),
(0,155,'分佣记录','commission/log/index','commission/log/index','CommissionLogIndex','select','D',2,'1',1,NULL,153,1,NULL),
...
(0,178,'收银设置','setting/cashier','setting/cashier','SettingCashier','select','A',2,'3',0,NULL,125,1,NULL),
